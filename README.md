...
See the Full Tech community Article from here: [Tracking Batch node state and duration in Log Analytics](https://techcommunity.microsoft.com/blog/AzurePaaSBlog/tracking-batch-node-state-and-duration-in-log-analytics/4547582)
